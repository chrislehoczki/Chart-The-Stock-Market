...
var StockContainer = React.createClass({
    ...
    updateStocks(stock) {
      ...
      socket.emit('clientStocks', {stock});
    ...
    render: function() {
       ...
       return (
          <div>
         <InputBox updateStocks={this.updateStocks} stocks={this.state.stocks} removeStock={this.removeStock}/>
...
var InputBox = React.createClass({
  ...
  render: function() {
    ...
    return (
      ...
      <Input type="text" label="Add Stocks" placeholder="Enter stock name" className="input" onChange={this.updateState} value={this.state.stock} onKeyPress={this.keyPress}/> 
...
var x = d3.time.scale().domain([minDate, maxDate]).range([0, width]);
 ...
 stocks.map(function(stock) {
    var lineGraph = svg.append("path")
      ...
      var totalLength = lineGraph.node().getTotalLength();   console.log(totalLength)
...
React.render(<StockContainer />, document.getElementById("stock-container"));
